...
resource "aws_codedeploy_app" "this" {
  ...
  tags = merge(var.tags, {
    yor_trace = "3ef2b96f-0059-470f-828c-cefceb67fd50"
  })
}
...
resource "aws_codedeploy_deployment_group" "this" {
  ...
  tags = merge(var.tags, {
    yor_trace = "efebb74d-4f61-482f-938e-f9dc8197638f"
  })
}
...
data "aws_iam_role" "codedeploy" {
  ...
  tags = {
    yor_trace = "96ad5ff5-cde4-47e8-9825-fdedf025c8bb"
  }
}
...
resource "aws_iam_policy" "triggers" {
  ...
  tags = merge(var.tags, {
    yor_trace = "506f8cc1-c0fe-478f-8793-4d4ee3e083d9"
  })
}
