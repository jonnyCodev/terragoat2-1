...
resource "aws_iam_role" "lambda" {
  ...
  tags = merge(var.tags, var.role_tags, {
    yor_trace = "20531bed-f7ec-42ad-a882-3f6951d0f96b"
  })
}
...
resource "aws_iam_policy" "logs" {
  ...
  tags = merge(var.tags, {
    yor_trace = "9e82ecdf-d315-4c8f-af8d-ce84e5755159"
  })
}
...
resource "aws_iam_policy" "dead_letter" {
  ...
  tags = merge(var.tags, {
    yor_trace = "06475fc7-fd25-4797-aed3-9fe35dfdc4ec"
  })
}
...
data "aws_iam_policy" "vpc" {
  ...
  tags = {
    yor_trace = "8fca5e45-ef36-4f68-8f7c-04518d8dab2e"
  }
}
...
data "aws_iam_policy" "tracing" {
  ...
  tags = {
    yor_trace = "f55ac4bf-acb8-437f-ada6-3e1fd6f7475f"
  }
}
...
resource "aws_iam_policy" "async" {
  ...
  tags = merge(var.tags, {
    yor_trace = "9d5a9b76-f3b5-424d-9655-838fd4df9a20"
  })
}
...
resource "aws_iam_policy" "additional_json" {
  ...
  tags = merge(var.tags, {
    yor_trace = "a2b6584f-ca31-447d-899e-ff3d97ae20ae"
  })
}
...
resource "aws_iam_policy" "additional_jsons" {
  ...
  tags = merge(var.tags, {
    yor_trace = "a6425ecc-748a-4477-b2fa-d1df49a8b246"
  })
}
...
resource "aws_iam_policy" "additional_inline" {
  ...
  tags = merge(var.tags, {
    yor_trace = "16c8e62b-d310-4e6f-ab9f-bd257766a12b"
  })
}
